...
exports.getOne = function(accessUserId, accessUserType, id, callback) {
    try {
        ...
        let where = {};
        let attributes = ['id', 'name','address','phone', 'email', 'open_at', 'activated', 'project_progress', 'desc', 'started_day', 'created_by', 'updated_by', 'created_at', 'updated_at'];
...
exports.update = function (accessUserId, accessUserType, accessLoginName, projectId, updateData, callback) {
    try {
        let queryObj = {};
        let where = {};
        ...
        if ( Pieces.VariableBaseTypeChecking(parseInt(updateData.project_progress), 'number')
            && (parseInt(updateData.project_progress) >= 0 && parseInt(updateData.project_progress) <= 100)) {
...
exports.delete = function(accessUserId, accessUserType, id, callback) {
    try {
        ...
        Project.findOne({where:where}).then(account=>{
            "use strict";
