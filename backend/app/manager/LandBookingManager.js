...
const LandBooking = Models.LandBooking;
...
module.exports = {
    ...
    try {
      ...
      LandBooking.findOne({
        ...
        if (result) {
          ...
          return callback(1, "invalid_LandBooking", 403, null, null);
        }
      });
    } catch (error) {
      return callback(1, "get_one_LandBooking_fail", 400, error, null);
    }
  },
  ...
  update: function (
    ...
    try {
      ...
      queryObj.booking_fee = updateData.booking_fee;
  ...
  delete: function (accessUserId, accessUserType, id, callback) {
    try {
      ...
      LandBooking.findOne({ where: where })
        .then((LandBooking) => {
          "use strict";
          if (LandBooking && LandBooking.deleted === Constant.DELETED.YES) {
            LandBooking.destroy({ where: where })
              .then((result) => {
                return callback(null, null, 200, null);
              })
              .catch(function (error) {
                return callback(1, "remove_LandBooking_fail", 420, error);
              });
          } else {
            LandBooking.update(queryObj, { where: where })
              .then((result) => {
              ...
              .catch(function (error) {
                return callback(1, "update_LandBooking_fail", 420, error);
              });
          }
        })
        .catch(function (error) {
          "use strict";
          return callback(1, "find_one_LandBooking_fail", 400, error, null);
        });
    } catch (error) {
      return callback(1, "delete_LandBooking_fail", 400, error);
    }
  },
  createByAdmin: function (accessUserId, accessUserType, accessLoginName, userData, callback) {
    try {
      ...
      queryObj.booking_fee = userData.booking_fee;
