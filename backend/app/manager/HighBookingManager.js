...
module.exports = {
    ...
    try {
      ...
      HighBooking.findOne({
        ...
        if (result) {
          ...
          return callback(1, "invalid_HighBooking", 403, null, null);
        }
      });
    } catch (error) {
      return callback(1, "get_one_HighBooking_fail", 400, error, null);
    }
  },
  ...
  update: function (
    ...
    try {
      ...
      HighBooking.update(queryObj, { where: where })
        .then((result) => {
          "use strict";
  ...
  delete: function (accessUserId, accessUserType, id, callback) {
    try {
      ...
      HighBooking.findOne({ where: where })
        .then((HighBooking) => {
          "use strict";
          if (HighBooking && HighBooking.deleted === Constant.DELETED.YES) {
            HighBooking.destroy({ where: where })
              .then((result) => {
                return callback(null, null, 200, null);
              })
              .catch(function (error) {
                return callback(1, "remove_HighBooking_fail", 420, error);
              });
          } else {
            HighBooking.update(queryObj, { where: where })
              .then((result) => {
              ...
              .catch(function (error) {
                return callback(1, "update_HighBooking_fail", 420, error);
              });
          }
        })
        .catch(function (error) {
          "use strict";
          return callback(1, "find_one_HighBooking_fail", 400, error, null);
        });
    } catch (error) {
      return callback(1, "delete_HighBooking_fail", 400, error);
    }
  },
