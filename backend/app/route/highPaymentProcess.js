const HighPaymentProcessCtrl = require('../controllers/HighPaymentProcessCtrl');
module.exports = function (app) {
     ...
     *     }
     */
    app.post('/v1/auth/highPaymentProcess', HighPaymentProcessCtrl.createByAdmin);
    /**
     ...
     *     }
     */
    app.get('/v1/auth/highPaymentProcess', HighPaymentProcessCtrl.getAll);
    /**
     ...
     *     }
     */
    app.get('/v1/auth/highPaymentProcess/:id', HighPaymentProcessCtrl.getOne);
    /**
     ...
     *     }
     */
    app.put('/v1/auth/highPaymentProcess/:id', HighPaymentProcessCtrl.update);
    /**
     ...
     *     }
     */
    app.delete('/v1/auth/highPaymentProcess/:id', HighPaymentProcessCtrl.delete);
    /**
