const HighListOwnerCtrl = require('../controllers/HighListOwnerCtrl');
module.exports = function (app) {
     ...
     *     }
     */
    app.post('/v1/auth/highListOwner', HighListOwnerCtrl.createByAdmin);
    /**
     ...
     *     }
     */
    app.get('/v1/auth/highListOwner', HighListOwnerCtrl.getAll);
    /**
     ...
     *     }
     */
    app.get('/v1/auth/highListOwner/:id', HighListOwnerCtrl.getOne);
    /**
     ...
     *     }
     */
    app.put('/v1/auth/highListOwner/:id', HighListOwnerCtrl.update);
    /**
     ...
     *     }
     */
    app.delete('/v1/auth/highListOwner/:id', HighListOwnerCtrl.delete);
    /**
