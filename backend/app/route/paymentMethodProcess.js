const PaymentMethodProcessCtrl = require('../controllers/PaymentMethodProcessCtrl');
module.exports = function (app) {
     ...
     *     }
     */
    app.post('/v1/auth/paymentMethodProcess', PaymentMethodProcessCtrl.createByAdmin);
    /**
     ...
     *     }
     */
    app.get('/v1/auth/paymentMethodProcess', PaymentMethodProcessCtrl.getAll);
    /**
     ...
     *     }
     */
    app.get('/v1/auth/paymentMethodProcess/:id', PaymentMethodProcessCtrl.getOne);
    /**
     ...
     *     }
     */
    app.put('/v1/auth/paymentMethodProcess/:id', PaymentMethodProcessCtrl.update);
    /**
     ...
     *     }
     */
    app.delete('/v1/auth/paymentMethodProcess/:id', PaymentMethodProcessCtrl.delete);
    /**
