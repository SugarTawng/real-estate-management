const HighSaleListCtrl = require('../controllers/HighSaleListCtrl');
module.exports = function (app) {
     ...
     *     }
     */
    app.post('/v1/auth/highSaleList', HighSaleListCtrl.createByAdmin);
    /**
     ...
     *     }
     */
    app.get('/v1/auth/highSaleList', HighSaleListCtrl.getAll);
    /**
     ...
     *     }
     */
    app.get('/v1/auth/highSaleList/:id', HighSaleListCtrl.getOne);
    /**
     ...
     *     }
     */
    app.put('/v1/auth/highSaleList/:id', HighSaleListCtrl.update);
    /**
     ...
     *     }
     */
    app.delete('/v1/auth/highSaleList/:id', HighSaleListCtrl.delete);
    /**
