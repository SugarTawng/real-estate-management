const LandSaleListCtrl = require('../controllers/LandSaleListCtrl');
module.exports = function (app) {
     ...
     *     }
     */
    app.post('/v1/auth/landSaleList', LandSaleListCtrl.createByAdmin);
    /**
     ...
     *     }
     */
    app.get('/v1/auth/landSaleList', LandSaleListCtrl.getAll);
    /**
     ...
     *     }
     */
    app.get('/v1/auth/landSaleList/:id', LandSaleListCtrl.getOne);
    /**
     ...
     *     }
     */
    app.put('/v1/auth/landSaleList/:id', LandSaleListCtrl.update);
    /**
     ...
     *     }
     */
    app.delete('/v1/auth/landSaleList/:id', LandSaleListCtrl.delete);
    /**
