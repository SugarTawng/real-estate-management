...
module.exports = function (app) {
   ...
   *     }
   */
  app.post("/v1/auth/customer", CustomerCtrl.createByAdmin);
  /**
   ...
   *     }
   */
  app.get("/v1/auth/customer", CustomerCtrl.getAll);
  // app.get("/v1/auth/customer/:id", CustomerCtrl.getCustomer);
  /**
   ...
   *     }
   */
  app.get("/v1/auth/customer/:id", CustomerCtrl.getOne);
  /**
   ...
   *     }
   */
  app.put("/v1/auth/customer/:id", CustomerCtrl.update);
  /**
   ...
   *     }
   */
  app.delete("/v1/auth/customer/:id", CustomerCtrl.delete);
};
