const HighBookingCtrl = require('../controllers/HighBookingCtrl');
module.exports = function (app) {
     ...
     *     }
     */
    app.post('/v1/auth/highBooking', HighBookingCtrl.createByAdmin);
    /**
     ...
     *     }
     */
    app.get('/v1/auth/highBooking', HighBookingCtrl.getAll);
    /**
     ...
     *     }
     */
    app.get('/v1/auth/highBooking/:id', HighBookingCtrl.getOne);
    /**
     ...
     *     }
     */
    app.put('/v1/auth/highBooking/:id', HighBookingCtrl.update);
    /**
     ...
     *     }
     */
    app.delete('/v1/auth/highBooking/:id', HighBookingCtrl.delete);
    /**
